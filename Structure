...
-- Généré le :  Jeu 07 Mars 2019 à 09:58
...
--
ALTER TABLE `CREER_QUESTION`
  ADD CONSTRAINT `FK_CREER_QUESTION` FOREIGN KEY (`MAIL`) REFERENCES `USER` (`MAIL`),
...
--
ALTER TABLE `ENSEIGNER`
  ADD CONSTRAINT `FK_ENSEIGNER` FOREIGN KEY (`MAIL`) REFERENCES `USER` (`MAIL`),
...
ALTER TABLE `INVITER`
  ...
  ADD CONSTRAINT `INVITER_ibfk_2` FOREIGN KEY (`MAIL_USER`) REFERENCES `USER` (`MAIL`) ON UPDATE CASCADE;
...
--
ALTER TABLE `NOTER`
  ADD CONSTRAINT `FK_NOTER` FOREIGN KEY (`MAIL_ETUDIANT`) REFERENCES `USER` (`MAIL`) ON UPDATE CASCADE,
...
--
ALTER TABLE `QUESTIONNAIRE`
  ADD CONSTRAINT `FK_CREER_QUESTIONNAIRE` FOREIGN KEY (`MAIL`) REFERENCES `USER` (`MAIL`) ON UPDATE CASCADE;
...
ALTER TABLE `REPONSE`
  ...
  ADD CONSTRAINT `FK_REPONDRE` FOREIGN KEY (`MAIL`) REFERENCES `USER` (`MAIL`);
